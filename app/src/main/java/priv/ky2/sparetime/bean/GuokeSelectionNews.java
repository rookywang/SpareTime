...
public class GuokeSelectionNews {
    ...
    public ArrayList<GuokeSelectionNews.result> getResult() {
        return result;
    }

    public void setResult(ArrayList<GuokeSelectionNews.result> result) {
        this.result = result;
    }
    ...
    public class result {
        ...
        public GuokeSelectionNews.source_data getSource_data() {
            return source_data;
        }

        public void setSource_data(GuokeSelectionNews.source_data source_data) {
