...
public class CollectionAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private List<GuokeSelectionNews.result> guokrList;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        return new WithTypeViewHolder(inflater.inflate(R.layout.collection_header, parent, false));
    }
        ...
        switch (types.get(position)) {
            ...
            case TYPE_GUOKR_NORMAL:
                ...
                if (!guokrList.isEmpty()) {
                    GuokeSelectionNews.result result = guokrList.get(position - zhihuList.size() - 2);
