 ...
 */
public class GuokeNewsAdapter extends RecyclerView.Adapter<GuokeNewsAdapter.GuokrPostViewHolder> {

    private final Context context;
    private final LayoutInflater inflater;
    private List<GuokeSelectionNews.result> list;

    private OnRecyclerViewOnClickListener mListener;

    public GuokeNewsAdapter(Context context, ArrayList<GuokeSelectionNews.result> list) {
