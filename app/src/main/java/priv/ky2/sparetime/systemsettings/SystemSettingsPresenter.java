...
public class SystemSettingsPresenter implements SystemSettingsContract.Presenter {

    private Context context;
    private SystemSettingsContract.View view;
    ...
    public SystemSettingsPresenter(Context context, SystemSettingsContract.View view){
